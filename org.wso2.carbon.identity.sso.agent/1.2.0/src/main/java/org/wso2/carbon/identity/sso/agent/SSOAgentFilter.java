...
public class SSOAgentFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
        ...
        try {
            ...
            // SAML Artifact from IdP
            String samlArtifact = request.getParameter(SSOAgentConstants.HTTP_PARAM_SAMLART);
            ...
            if (SSOAgentConfigs.isSAMLSSOLoginEnabled() && samlArtifact != null) {
                LOGGER.info("SAML Artifact Received");
                // TODO check for relevant conditions
                try {
                    samlSSOManager.processArtifact(samlArtifact, request);
                } catch (SSOAgentException e) {
            ...
            } else if(SSOAgentConfigs.isSAMLSSOLoginEnabled() && samlRequest != null){
